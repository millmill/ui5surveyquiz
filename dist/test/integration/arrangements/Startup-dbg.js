sap.ui.define([
	"sap/ui/test/Opa5",
	"demo/survey2/SurveyDemo2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("demo.survey2.SurveyDemo2.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "SURVEYS/" + encodeURIComponent(sObjectId);
