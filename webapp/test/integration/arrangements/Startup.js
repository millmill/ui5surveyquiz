sap.ui.define([
	"sap/ui/test/Opa5",
	"internalSurveyTool/internalSurveyTool/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("internalSurveyTool.internalSurveyTool.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "internalSurveyTool.internalSurveyTool",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "mytable/" + encodeURIComponent(sObjectId);
