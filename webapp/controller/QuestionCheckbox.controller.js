sap.ui.define([
	...
	return Controller.extend("demo.survey2.SurveyDemo2.controller.QuestionCheckbox", {
		onNavBack : function() {
		...
		*/
		...
		onRemove : function () {
			if (answers > 2){
				answers -= 1;
				this.getView().byId("check" + answers).setVisible(false);
		...
		onAdd : function () {
			if (answers < 5){
				this.getView().byId("check" + answers).setVisible(true);
